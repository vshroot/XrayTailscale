...
if github_raw_curl "${RAW_BASE_URL}/xrayebator" --connect-timeout 10 --max-time 60 -o "$XRAYEBATOR_TMP" \
   && [[ -s "$XRAYEBATOR_TMP" ]] \
...
echo -e "  ${CYAN}sudo xrayebator-update${NC}    - обновить XrayTailscale"
echo -e "  ${CYAN}sudo xrayebator-uninstall${NC} - удалить XrayTailscale"
echo ""
