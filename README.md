...
```bash
read -rsp 'GitHub token: ' GH_TOKEN; echo; sudo env XRAYTAILSCALE_GITHUB_TOKEN="$GH_TOKEN" xrayebator-update main
```
...
sudo curl -fsSL -H "Authorization: Bearer $GH_TOKEN" https://raw.githubusercontent.com/vshroot/XrayTailscale/main/xrayebator -o /usr/local/bin/xrayebator
